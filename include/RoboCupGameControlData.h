...
struct RoboCupGameControlData {
    ...
    uint16 secsRemaining;       // estimate of number of seconds remaining in the half
    uint16 secondaryTime;       // number of seconds shown as secondary time (remaining ready, until free ball, etc)
    TeamInfo teams[2];
};
