...
import bhuman.message.messages.ObstacleModelCompressed.Obstacle.Type;
...
public class Obstacle extends PerPlayer {
    ...
    public static final double OBSTACLE_HEIGHT = 0.30;
        ...
        if (rs.getLastMessage() != null
            ...
            if (obstacleModel != null) {
                ...
                for (final ObstacleModelCompressed.Obstacle obstacle : obstacleModel.obstacles) {
                    ...
                    gl.glVertex3f(obstacle.left.x, obstacle.left.y, 0.f);
                    gl.glVertex3f(obstacle.center.x, obstacle.center.y, 0.f);
                    gl.glVertex3f(obstacle.right.x, obstacle.right.y, 0.f);
                    gl.glEnd();
